...
suspend inline fun <reified T> IModuleStorage.getOrDefault(key: String, noinline defaultValue: () -> T): T = getOrDefault(
    key,
    defaultValue,
    T::class.java
)
...
suspend inline fun <reified T> IModuleStorage.getListOrDefault(key: String, noinline defaultValue: () -> List<T>): List<T> = getListOrDefault(
    key,
    T::class.java,
    defaultValue
)
