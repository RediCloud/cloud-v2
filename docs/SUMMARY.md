...
* [Server versions](commands/server-versions.md)
* [Server version types](commands/server-version-types.md)
* [Java versions](commands/java-versions.md)
* [Configuration template](commands/configuration-template.md)
* [File templates](commands/file-templates.md)
* [Module](commands/module.md)
* [Screen](commands/screen.md)
* [Cluster](commands/cluster.md)
* [Version / Updater](commands/version-updater.md)
* [Server](commands/server.md)

## FAQ

* [Minestom support](faq/minestom-support.md)
* [Own server versions](faq/own-server-versions.md)
